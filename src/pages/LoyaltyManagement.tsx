...
const LoyaltyManagement: React.FC = () => {
  ...
  const deleteExistingCode = async () => {
    try {
      ...
      setStatus('error');
      setMessage(error instanceof Error ? error.message : 'حدث خطأ أثناء حذف الكود');
    } finally {
      setIsDeleting(false);
      ...
      <div className="container p-6">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <h1>
              اضغط على الزر أدناه لتوليد كود يومي جديد (4 أرقام) لجميع الطاولات.
              سيتم تخزين هذا الكود في قاعدة البيانات وسيكون صالحًا لليوم الحالي فقط.
            </h1>
            ...
            <div className="flex gap-4">
              ...
              {existingCode && (
                <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>هل أنت متأكد من حذف الكود الحالي؟</AlertDialogTitle>
                      <AlertDialogDescription>
                        <p className="text-red-500 font-bold mb-2">تحذير هام!</p>
                        <p>حذف الكود الحالي سيؤدي إلى:</p>
                        <ul className="list-disc list-inside my-2">
                          <li>عدم قدرة الزبائن على استخدام الكود الحالي</li>
                          <li>حدوث مشاكل مع الزبائن الذين يحاولون استخدام الكود القديم</li>
                          <li>الحاجة إلى إبلاغ جميع الزبائن بالكود الجديد بعد إنشائه</li>
                        </ul>
                        <p className="mt-2">يرجى التأكد من إبلاغ جميع الموظفين والزبائن بهذا التغيير.</p>
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      ...
                      >
                        {isDeleting ? 'جاري الحذف...' : 'نعم، أريد الحذف'}
                      </AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
