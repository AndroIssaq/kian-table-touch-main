...
const UserHome = () => {
    ...
    const slides = [
        ...
        {
            emoji: '🧋',
            title: { ar: 'مشروب بوبا جديد!', en: 'New Boba drink!' },
            desc: {
        ...
        {
            emoji: '🧁',
            title: { ar: 'كاب كيك مجاني للأطفال', en: 'Free cupcake for kids' },
            desc: { ar: 'كل يوم جمعة وسبت', en: 'Every Friday and Saturday' },
        },
        {
            emoji: '☀️',
            title: {
            ...
            desc: { ar: 'من 8 صباحًا حتى 11 صباحًا', en: 'From 8am to 11am' },
        },
    ]
    ...
    const suggestions = [
        ...
        },
        {
            emoji: '🧋',
            title: {
                ar: 'جرب مشروب البوبا الجديد',
                en: 'Try the new Boba drink',
            },
