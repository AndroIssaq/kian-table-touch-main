    ...
    >
      {tables.map((tableNumber) => (
        ...
        >
          ...
          >
            <span className={`absolute inset-0 rounded-full pointer-events-none transition-all duration-200 ${selectedTable === tableNumber ? 'shadow-[0_0_40px_10px_rgba(255,215,0,0.3)]' : 'shadow-[0_2px_12px_0px_rgba(0,0,0,0.08)]'}`}></span>
            {/* أيقونة ترابيزة SVG عصرية */}
            <span className="absolute bottom-2 left-1/2 -translate-x-1/2 z-10">
              <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="19" cy="15" rx="15" ry="8" fill={selectedTable === tableNumber ? '#FFD700' : '#E5E7EB'} stroke="#B08D57" strokeWidth="2" />
                <rect x="8" y="15" width="22" height="10" rx="5" fill={selectedTable === tableNumber ? '#FFF9E3' : '#F3F4F6'} stroke="#B08D57" strokeWidth="2" />
                <rect x="13" y="25" width="3" height="7" rx="1.5" fill="#B08D57" />
                <rect x="22" y="25" width="3" height="7" rx="1.5" fill="#B08D57" />
              </svg>
            </span>
